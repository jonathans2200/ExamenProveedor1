...
a persistence unit "ExamenProveedor1PersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "ExamenProveedor1\pom.xml":
...
artifact ("ExamenProveedor1.war") is already built. You can build
